...
pub(crate) async fn tg_get_graph_inputs(
...
pub(crate) async fn tg_read_prompt_file(
    State(state): State<AppState>,
...
pub(crate) async fn tg_write_prompt_file(
    State(state): State<AppState>,
    Path((_project, _scope, _graph_id)): Path<(String, String, String)>,
...
pub(crate) struct WritePromptFileBody {
    pub path: String,
    pub content: String,
}
